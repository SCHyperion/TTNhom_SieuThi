...
namespace QuanLySieuThi.User_Controls
{
    public partial class uc_SanPham : UserControl
    {
        void loadButton()
        {
            ...
            path.AddEllipse(4, 4, btn_Them.Width - 8, btn_Them.Height - 8);
            btn_Them.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btn_Sua.Width - 8, btn_Sua.Height - 8);
            btn_Sua.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btn_CapNhat.Width - 8, btn_CapNhat.Height - 8);
            btn_CapNhat.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btn_TimKiem.Width - 8, btn_TimKiem.Height - 8);
            btn_TimKiem.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btn_Xoa.Width - 8, btn_Xoa.Height - 8);
            btn_Xoa.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btn_Thoat.Width - 8, btn_Thoat.Height - 8);
            btn_Thoat.Region = new Region(path);
            path.Reset();
        }
        public uc_SanPham()
        {
