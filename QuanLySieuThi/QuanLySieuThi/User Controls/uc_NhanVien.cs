...
namespace QuanLySieuThi.User_Controls
{
    public partial class uc_NhanVien : UserControl
    {
        ...
        void loadButton()
        {
            ...
            path.AddEllipse(4, 4, btnXemNV.Width - 8, btnXemNV.Height - 8);
            btnXemNV.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btnThemNV.Width - 8, btnThemNV.Height - 8);
            btnThemNV.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btnSuaNV.Width - 8, btnSuaNV.Height - 8);
            btnSuaNV.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btnXoaNV.Width - 8, btnXoaNV.Height - 8);
            btnXoaNV.Region = new Region(path);
            path.Reset();

            path.AddEllipse(4, 4, btnTimKiemNV.Width - 8, btnTimKiemNV.Height - 8);
            btnTimKiemNV.Region = new Region(path);
            path.Reset();
        }
        public uc_NhanVien()
        {
